...
- Make that a narrow candidate check: name the two or three Korean expressions you are considering in the Supermemory query and ask whether each is in the 2k baseline or has a **Learning**/**Seen** state. Do not issue a broad request for stored lesson content.
